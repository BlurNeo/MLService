...
class MLClient(object):
    ...
    def request_metadata(self):
        ...
        try:
            ...
            print('metadata response: ', result)
...
if __name__ == "__main__":
    ...
    predict_dataset = [
        ...
        # work_dir + 'dataset/OK/25.jpg',
        # work_dir + 'dataset/OK/26.jpg',
        # work_dir + 'dataset/OK/27.jpg',
        # work_dir + 'dataset/OK/28.jpg',
        # work_dir + 'dataset/OK/29.jpg',
        # work_dir + 'dataset/OK/30.jpg'
    ]
